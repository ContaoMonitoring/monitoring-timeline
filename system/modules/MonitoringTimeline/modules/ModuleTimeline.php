...
/**
 * Back end module "Timelines".
 *
 * @author     Cliff Parnitzky
 */
class ModuleTimeline extends \BackendModule
{
   ...
   * @var string
   */
  protected $strTemplate = 'monitoring_timeline';
  ...
  {
    \System::loadLanguageFile('tl_monitoring_timeline');
